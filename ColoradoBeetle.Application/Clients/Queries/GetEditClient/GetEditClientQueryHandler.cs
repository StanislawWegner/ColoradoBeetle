...
namespace ColoradoBeetle.Application.Clients.Queries.GetEditClient;
public class GetEditClientQueryHandler : IRequestHandler
        <GetEditClientQuery, EditClientCommand> {
    private readonly IApplicationDbContext _context;

    public GetEditClientQueryHandler(IApplicationDbContext context) {
        _context = context;
    }
    public async Task<EditClientCommand> Handle(GetEditClientQuery request
